...
env = SpaceCadetEnv(recompensa="score", quadros_por_passo=3, max_passos=12000, comprimir=True, bonus_vivo=0.0)
m = PPO.load("ppo4_score", device="cpu")
obs, _ = env.reset()
...
for i in range(4000):
    ...
    vivo_r.append(0.0); score_r.append(r)
    if term or trunc:
        obs, _ = env.reset()
